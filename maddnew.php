...
if (isset($_POST['saveAccount']))
{
  ...
  if (!$con->query("insert into useraccounts (name,cnic,myfile,nidfile,accountNo,accountType,city,address,email,password,balance,source,number,branch) values ('$_POST[name]','$_POST[cnic]','$_POST[filename]','$_POST[nidfile]','$_POST[accountNo]','$_POST[accountType]','$_POST[city]','$_POST[address]','$_POST[email]','$_POST[password]','$_POST[balance]','$_POST[source]','$_POST[number]','$_POST[branch]')")) {
    ...
    <table class="table">
      <tbody>
        ...
        <tr>
          ...
          <th>User picture</th>
          <td> <input type="file" id="myfile" name="myfile" class="form-control input-sm" required></td>
          <th>NID attachment</th>
          <td><input type="file" id="nidfile" name="nidfile"  class="form-control input-sm" required></td>
        </tr>
        <tr>
